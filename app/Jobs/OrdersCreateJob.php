 ...
 * OrdersCreateJob
 *
 * Handles the orders/create Shopify webhook.
 * Resolves the shop via IShopQuery then delegates all business logic to OrderWebhookService.
 */
class OrdersCreateJob implements ShouldQueue
{
    ...
    public function handle(IShopQuery $shopQuery): void
    {
        ...
        if (! $user) {
            Log::error('[OrdersCreateJob] Shop user not found', [
        ...
        try {
            ...
            Log::info('[OrdersCreateJob] Completed successfully', [
                'shop'  => $shopDomainNative,
                'topic' => 'orders/create',
            ]);
        } catch (Throwable $e) {
    ...
    public function failed(Throwable $e): void
    {
        ...
        Log::error('[OrdersCreateJob] Permanently failed after all retries', [
            'shop'  => $domain,
            'error' => $e->getMessage(),
        ]);
    }
